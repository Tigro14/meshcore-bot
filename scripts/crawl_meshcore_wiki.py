#!/usr/bin/env python3
"""
Crawler dédié pour la section Meshcore de https://wiki.mesh-idf.fr
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Crawl la section Meshcore du Wiki.js mesh-idf au format JSONL RAG."
    )
    parser.add_argument("--base-url", default="https://wiki.mesh-idf.fr", help="URL de base Wiki.js")
    ...
    parser.add_argument("--output", default="data/wiki_rag/meshcore_wiki_pages.jsonl", help="Fichier JSONL de sortie")
